...
A: Generation and visualization of structures using a Monte Carlo Search followed by conjugated gradient optimization
...
#The MS connectivity score applies to the cases where more than two input coordinate files are specified (currently not supported in this package release).
	...
	(4)	Hall, Z.; Politis, A.; Robinson, C. V. Structure 2012, 20, 1596-609.
